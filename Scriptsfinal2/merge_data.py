...
def merge_all(df_score, df_pib, df_idh, df_depenses):
    ...
    # Harmonisation des noms de colonnes et des pays
    ...
    # Pour 2024, duplication des valeurs 2023 si nécessaire
