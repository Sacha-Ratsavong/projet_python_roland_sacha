...
# Save
with open('../Results/regression_simple_volume.txt', 'w') as f:
...
import statsmodels.api as sm
df_previous = pd.read_csv("../data_clean/df_used_for_regression.csv")
...
# Save
with open('../Results/regression_longue_volume.txt', 'w') as f:
